...
/// AI: The project name is xcli.
/// AI: Replace xcli with the actual project name in all docs/paths below.
...
// The version.h file is generated from xcli/version.h.in
// and contains the following compile-time macros:
/// @{
/// @brief XCLI_VERSION_MAJOR / _MINOR / _PATCH  — version components
/// @brief XCLI_VERSION_STRING  — e.g. "0.0.5"
/// @brief XCLI_SIMD_LEVEL  — target SIMD level string
/// @brief XCLI_SIMD_ENABLE_SSE..AVX512F  — 0 or 1 per feature
/// @brief XCLI_CXX_COMPILER_ID     — compiler name
/// @brief XCLI_CXX_COMPILER_VERSION — compiler version
/// @brief XCLI_BUILD_TYPE_STRING       — Debug/Release/etc
/// @brief XCLI_BUILD_SYSTEM        — OS distro name
/// @brief XCLI_GIT_COMMIT_HASH     — full git commit
/// @brief XCLI_GIT_VERSION_STRING  — "tag-hash[-dirty]"
/// @}
