...
int main(int argc, char **argv) {
    xcli::App app{"An app to practice mixing unlimited arguments, but still recover the original order."};
    ...
    // Standard parsing lines (copy and paste in, or use XCLI_PARSE)
    try {
        app.parse(argc, argv);
